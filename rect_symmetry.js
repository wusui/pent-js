 ...
 */
const alignBoard = board => (board[0].length % 2 == 1) ? flipBoard(board) :
  board;
 ...
 */
const flipBoard = board => board.reduce((prev, next) => next.map((item, i) =>
 ...
 */
const findCenter = board => (board.length % 2 == 0) ? false :
